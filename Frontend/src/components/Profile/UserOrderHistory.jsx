        ...
        <div className="h-[100%] p-0 md:p-4 text-zinc-100 ">
          ...
          <div className="mt-4 bg-zinc-800 w-full rounded py-2 px-4 flex gap-2">
            ...
            <div className="w-[30%] md:w-[20%]">
              <h1 className="">Placed On</h1>
            </div>
          </div>
          {OrderHistory.map((items, i) => (
            <div className="bg-zinc-800 text-left rounded py-2 px-4 flex justify-start gap-2 hover:bg-zinc-900 hover:cursor-pointer transition-all duration-300">
              <div className="w-[5%]">
                <h1 className="">{i + 1}</h1>
              </div>
              <div className="w-[40%] md:w-[22%]">
              ...
              <div className="w-0 md:w-[40%] hidden md:block">
                <h1 className="">{items.book.desc.slice(0, 40)}...</h1>
              </div>
              <div className="w-[17%] md:w-[9%]">
